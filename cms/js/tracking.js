    ...
    var Tracker = {
        ...
        debounceSpaAccess: function (baseHost, clientId, domains) {
            ...
            if (this.debounceSpaAccessTimerId) {
                ...
                this.debounceSpaAccessTimerId = null;
            }
            var self = this;
        ...
        initElementEvent: function () {
            ...
            if (this.removeEventListenerList.length) {
                ...
                for (var relIdx = 0; relIdx < tmpRemoveEventListenerList.length; relIdx++) {
                    // 追加したイベントの削除
                    tmpRemoveEventListenerList[relIdx]();
                }
            }
            ...
            var useTtrEpStatus = typeof window.history.state === 'string' && window.history.state.substring(0, 7) == 'ttr_ep_';
            if (useTtrEpStatus) {
        ...
        notifyConversion: function () {
            var self = this;
            this.waitCheckFunc(function () {
                return typeof self.execSpaAccess === 'undefined' || self.execSpaAccess === false;
            }, function () {
                if (self.conversion) {
                    return;
                }
    ...
    var init = function () {
        ...
        window[queueName + '_event'] = {
            ...
            addTimeoutId: function (timeoutId, diffTime) {
                ...
                setTimeout(function () {
                    if (typeof Tracker.timeoutIdList[timeoutId] === 'undefined') {
                        return;
                    }
